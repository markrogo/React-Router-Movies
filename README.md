...
<!-- * [ ] The Movie Card should be flexible enough to handle displaying a movie with or without the list of stars. (sort of, i just called it without the stars and left that code in the one place it's used) -->
